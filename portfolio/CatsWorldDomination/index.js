window.addEventListener("scroll", function (event) {
    ...
    if ((scroll*100)/(document.documentElement.scrollHeight - document.documentElement.clientHeight) == 100) {
        document.querySelector("nav").classList.add("navfin");
    } else {
        document.querySelector("nav").classList.remove("navfin");
    }
})